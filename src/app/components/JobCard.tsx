...
export default function JobCard({
  ...
  const { title, description, location, salary, tags } = jobListing
  ...
  return (
    <div className="bg-[var(--background)] border border-[var(--accent)] rounded-xl p-6 transition-all hover:border-[var(--accent-light)] hover:shadow-[0_0_15px_rgba(59,130,246,0.3)] space-y-4">
